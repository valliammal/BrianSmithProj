<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="Industry.aspx.cs" Inherits="Industry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        //load Industry fom database
        $(document).ready(function () {


            $.ajax({
                type: "POST",
                url: "Industry.aspx/jsonstring",
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < obj.length; i++) {
                        ...
                        $('#RightDiv').append("<p id='box" + [i] + "' class='draggable-item'>" + obj[i].Industry_Name + "</p>");
    ...
    <div class="">
        ...
        <div id="divMainHobbyIndustry">
            ...
            <p id="divHobbyIndustryP">Select Your Industry</p>
            <br />
            <br />
            <span class="divIndustrySpanLeft">Industry in which I work</span>
            <span class="divIndustrySpanCenter">Industry in which I would like
                       to work</span>
            <span class="divIndustrySpanRight">List of all industries</span>
            <br />
            <br />
