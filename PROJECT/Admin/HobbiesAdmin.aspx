<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HobbiesAdmin.aspx.cs" Inherits="HobbiesAdmin" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin(Hobbies)</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div align="center">
            <h2>Here you can add your hobby</h2>
            <br />
            <div style="width: 280px">
                Hobby&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                
                            <asp:TextBox ID="txtHobby" runat="server" onKeyPress="return ValidateAlpha(event);"></asp:TextBox>
                <br />
                <br />
                <div id="btnHobbyWidth">
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" ToolTip="Click to add this language" CssClass="Langbtn" OnClick="btnSubmit_Click" />
        ...
        <div align="center">
            <asp:Panel ID="PanelGrid" runat="server" Width="1000px" Visible="false">
                ...
                <div id="gridAdmin">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" DataKeyNames="Hobby_ID">
                        <Columns>
                            <asp:TemplateField HeaderText="ID" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="Wheat">
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%#Eval("Hobby_ID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Hobby" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="Wheat">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%#Eval("Hobby_Name") %>'></asp:Label>
                                </ItemTemplate>
